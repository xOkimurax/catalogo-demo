...
const SUPABASE_URL = environment.SUPABASE_URL; // URL de tu proyecto Supabase
const SUPABASE_PUBLISHABLE_KEY = environment.SUPABASE_ANON_KEY; // Clave anónima de Supabase
